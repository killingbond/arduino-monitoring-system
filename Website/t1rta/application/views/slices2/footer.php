<footer class="main-footer">
    ...
    <strong>Developed By Ozan Soft. Powered By <a href="http://almsaeedstudio.com">Almsaeed Studio</a>.</strong>
</footer>
...
<!-- DataTables -->
<script src="<?php base_url2()?>template/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?php base_url2()?>template/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- SUMMERNOTE -->
<script src="<?php echo base_url()?>template/summernote/dist/summernote.js"></script>

<!-- AdminLTE App -->
<script src="<?php base_url2()?>template/dist/js/app.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php base_url2()?>template/dist/js/pages/dashboard.js"></script>
