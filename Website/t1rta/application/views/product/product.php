...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Product
            <small>Debir Air</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php base_url(); ?> product">Debit</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Monitoring Debit Air</h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                        <ul class="pagination">
                            <li <?php if($page==1)echo 'class="disabled"'?>><a <?php if($page>1){?>href="<?php echo base_url()."product/index/1/".$order."/".$max."/".$search;?>"<?php }?>>First</a></li>
                            <li <?php if($page==1)echo 'class="disabled"'?>><a <?php if($page>1){?>href="<?php echo base_url()."product/index/".($page-1)."/".$order."/".$max."/".$search;?>"<?php }?>>Previous</a></li>
